<!-- component -->
@if (request()->is('admin*'))
    <nav class="w-full px-4 py-4 flex justify-between items-center bg-white top-0 drop-shadow-lg fixed">
        ...
        <ul
            ...
            <li><a class="text-sm {{ request()->is('admin') ? 'text-blue-600 font-bold' : 'text-gray-400' }}  hover:text-gray-500"
                    href="{{ route('admin.index') }}">Home</a></li>
            <li><a class="text-sm {{ request()->is('admin/user*') ? 'text-blue-600 font-bold' : 'text-gray-400' }}"
                    href="{{ route('admin.user.index') }}">User</a></li>
            <li><a class="text-sm {{ request()->is('admin/task*') ? 'text-blue-600 font-bold' : 'text-gray-400' }}"
                    href="{{ route('admin.task.index') }}">Task</a></li>
...
@if (request()->is('user*'))
    <nav class="w-full px-4 py-4 flex justify-between items-center bg-white top-0 drop-shadow-lg fixed">
        ...
        <ul
            class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
            <li><a class="text-sm {{ request()->is('user') ? 'text-blue-600 font-bold' : 'text-gray-400' }}  hover:text-gray-500"
